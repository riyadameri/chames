                  ...
                  >
                    <div className="relative">
                      <img
                        src={post.authorAvatar}
                        alt={post.authorName}
                        className="w-11 h-11 rounded-2xl object-cover border-2 border-emerald-500 group-hover:scale-105 transition"
                      />
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500 flex items-center gap-2 mt-0.5">
                        ...
                        <span>•</span>
                        <span>{new Date(post.createdAt).toLocaleDateString('ar-DZ')}</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1 sm:gap-2">
                      ...
                      >
                        <Flame className={`w-4 h-4 ${post.reactions?.fire?.includes(currentUser.id) ? 'fill-amber-500 text-amber-500' : 'text-amber-500'}`} />
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-emerald-50 hover:text-emerald-700 text-slate-700 text-xs font-bold transition cursor-pointer"
